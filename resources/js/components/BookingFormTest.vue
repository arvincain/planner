		                ...
		                <!--        You can switch " data-color="blue" "  with one of the next bright colors: "green", "orange", "red", "purple"             -->
								...
								<div class="wizard-navigation">
									<ul>
                                        ...
                                        <li><a href="#services" data-toggle="tab">Service Needed</a></li>
		                        ...
		                        <div class="tab-content">
		                            ...
		                            <div class="tab-pane" id="description">
		                                <div class="row">
		                                    <h4 class="info-text"> Any other notes or requests you want to let the suppliers know? </h4>
                                            <h6 class="info-text"> You can let them know the theme of your event or any special requests. Please DON'T enter any contact details like email or phone numbers </h6>
